...
import { Hospital, Doctor } from '@/Components/Shared/Types';
import { mockDoctors } from '@/Components/Shared/MockData';
import { 
  MapPinIcon, 
  PhoneIcon, 
  ClockIcon, 
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Đang tải thông tin bệnh viện...</p>
        </div>
      </div>
    );
  }
